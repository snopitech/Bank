        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-2 sm:py-3">
          <div className="flex flex-col sm:flex-row items-center justify-between mx-auto" style={{ maxWidth: '100%' }}>
            <div className="flex flex-wrap justify-center sm:justify-start gap-3 sm:gap-4 md:gap-6 lg:gap-8 mb-2 sm:mb-0">
              ...
              <a href="/transfer" onClick={handleTransferClick} className="hover:text-red-700 transition-colors text-xs sm:text-sm md:text-base font-medium whitespace-nowrap">Transfer & Pay</a>
              ...
              <a href="#" onClick={handleMakePaymentClick} className="text-gray-600 hover:text-red-700 transition-colors text-xs sm:text-sm md:text-base font-medium whitespace-nowrap border-l-2 border-gray-300 pl-3 sm:pl-4">Make Payment</a>
            </div>
