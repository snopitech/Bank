...
export default function AdminProfile() {
  ...
  useEffect(() => {
    const fetchEmployeeData = async () => {
      ...
      setLoading(true);
      try {
        const response = await fetch(`${API_BASE}/api/employees/admin/${user.id}`);
  ...
  const handleCancelEdit = () => {
    setIsEditing(false);
    // Reset form to original employeeData
    if (employeeData) {
      setFormData({
  ...
  // 👈 UPDATED: Open password modal instead of alert
  const handleChangePassword = () => {
    setShowPasswordModal(true);
  };

  // 👈 ADD THIS: Handle successful password change
            ...
            <div style={styles.profileInfo}>
              ...
              <div>
                ...
                <div style={styles.profileMeta}>
                  {employeeData.role} • {employeeData.department} • Employee since {new Date(employeeData.createdAt).getFullYear()}
                </div>
              </div>
            </div>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.grid2}>
            ...
            <div style={styles.fieldGroup}>
              ...
              <div style={styles.value}>•••-••-{employeeData.maskedSsn?.slice(-4) || employeeData.ssnLastFour}</div>
            </div>
            <div style={styles.fieldGroup}>
